using Apps.CrowdinEnterprise.Webhooks.Handlers.Organization;
...
public class OrganizationWebhookList
{
    ...
    public Task<WebhookResponse<ProjectWithUserWebhookResponse>> OnProjectCreated(WebhookRequest webhookRequest)
        => HandleWebhookRequest<ProjectWithUserWebhookResponse, ProjectWithUserWrapper>(webhookRequest);
    ...
    [Webhook("On group created", typeof(GroupCreatedHandler), Description = "On group created")]
    ...
    [Webhook("On group deleted", typeof(GroupDeletedHandler), Description = "On group deleted")]
